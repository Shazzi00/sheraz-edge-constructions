      ...
      <section className="flex-grow max-w-7xl mx-auto w-full px-6 py-12 space-y-10">
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-slate-600 text-xs sm:text-sm">
            Comprehensive engineering and construction solutions tailored to commercial, residential, and infrastructure projects.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((item) => (
              ...
              >
                ...
                <img
                  src={getImageUrl(item.image) || '/placeholder-service.jpg'}
                  alt={item.title}
                ...
                <div className="relative p-6 z-10 flex flex-col justify-end space-y-1">
                  ...
                  <div className="max-h-0 opacity-0 group-hover:max-h-36 group-hover:opacity-100 transition-all duration-300 ease-in-out overflow-hidden space-y-3 pt-1">
                    <p className="text-xs text-slate-300 line-clamp-2 leading-relaxed">
                      {item.short_desc || item.content || 'Explore our full spectrum of structural engineering solutions.'}
                    </p>
                    <div>
