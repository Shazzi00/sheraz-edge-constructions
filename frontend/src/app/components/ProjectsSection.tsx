      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-slate-400 text-sm">
            No projects added yet. Add projects from the admin panel to display them here.
          </div>
        ) : (
            ...
            {displayedProjects.map((project) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-950/40 to-transparent p-6 flex flex-col justify-end transition-all duration-300">
                  ...
                  {(project.location || project.construction_type) && (
                    <p className="text-xs text-pink-400 font-semibold mb-2">
                      {[project.location, project.construction_type].filter(Boolean).join(' • ')}
                    </p>
                  )}
